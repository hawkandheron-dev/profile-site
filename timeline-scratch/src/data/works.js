export const works = [
  ...
  { name: "Longer Rules (Regulae Fusius Tractatae)", authors: ["Basil the Great"] },
  { name: "Shorter Rules (Regulae Brevius Tractatae)", authors: ["Basil the Great"] },
  {
  ...
  { name: "Oration 43: Funeral Oration on Basil", authors: ["Gregory of Nazianzus"] },
  ...
  { name: "Lives of the Hermits (Paul, Hilarion, Malchus)", authors: ["Jerome"] },
  ...
  { name: "On the Trinity (De Trinitate) (attributed)", authors: ["Didymus the Blind"] },
  ...
  { name: "Commentary on Luke (fragments/selected)", authors: ["Cyril of Alexandria"] },
  ...
  { name: "On Ecclesiastical Offices (De Ecclesiasticis Officiis)", authors: ["Isidore of Seville"] },
  { name: "History of the Goths, Vandals, and Suevi", authors: ["Isidore of Seville"] },
  ...
  { name: "Letters (selected)", authors: ["Sylvester II / Gerbert of Aurillac"] },
  {
    ...
    authors: ["Sylvester II / Gerbert of Aurillac"]
  },
  ...
  { name: "Latin Translation of Proclus’ Elements of Theology", authors: ["William of Moerbeke"] },
  {
  ...
  { name: "On the Revolutions of the Heavenly Spheres (De Revolutionibus Orbium Coelestium)", authors: ["Nicholas Copernicus"] },
  { name: "A Short Account of the Destruction of the Indies", authors: ["Bartolome de las Casas"] },
  { name: "History of the Indies (Historia de las Indias)", authors: ["Bartolome de las Casas"] },
  ...
  { name: "On the Providence of God (De Providentia Dei)", authors: ["Huldrych Zwingli"] },
  ...
  { name: "Philosophiæ Naturalis Principia Mathematica", authors: ["Sir Isaac Newton"] },
...
const worksByAuthor = works.reduce((map, work) => {
